<x-app-layout>
    <div class="flex items-center justify-center py-5 px-5">
        ...
        <div class="mx-auto w-full max-w-full">
            <form id="consulta-form" action="{{ route('consultas.store', ['citaId' => $cita->id]) }}" method="POST">
                @csrf
                ...
                <div class="shadow-xl p-5 rounded-lg bg-white mb-5">
                    ...
                    <textarea id="motivo" name="motivo" placeholder="Ingrese el motivo de la consulta" maxlength="200" class="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
                ...
                <div class="shadow-xl p-5 rounded-lg bg-white mb-5">
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="tension_arterial" name="tension_arterial" placeholder="120/80" class="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-4 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                    </div>  
                </div>
                ...
                <div class="shadow-xl p-5 rounded-lg bg-white mb-5">
                    ...
                    <textarea id="padecimiento" name="padecimiento" placeholder="Ingrese el padecimiento del paciente" maxlength="200" class="w-full resize-none rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"></textarea>
                    <div class="text-right text-sm text-gray-500">
                ...
                <button type="submit" class="hover:shadow-form rounded-md bg-[#6A64F1] py-3 px-8 text-base font-semibold text-white outline-none">Crear Consulta</button>
            </form>
        </div>
    </div>
